...
function verifyKhaltiPayment(payload, amt, targetBtn) {
    ...
    // ajax call
    $.post("https://khalti.com/api/payment/verify/", payload, function (resp) {
...
$(function () {
    $(".pay-khalti").on('click', function (e) {
        ...
        var config = {
            ...
            "publicKey": "test_public_key_2b6fa46ea8aa4972a124608834fc57a2",
            ...
            "eventHandler": {
                onSuccess(payload) {
                    ...
                    self.addClass("disabled");
                    self.html("Purchased")
                    document.getElementById("enroll_btn").hidden = false;
